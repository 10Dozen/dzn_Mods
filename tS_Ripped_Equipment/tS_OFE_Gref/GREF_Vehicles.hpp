...
// {
	...
	class rhsgref_nat_gray: rhsgref_nat_base
	{
		_generalMacro = "rhsgref_nat_gray";
		author = "$STR_RHS_AUTHOR_FULL";
		scope = 1;
		uniformClass = "rhsgref_uniform_gray";
		hiddenSelections[] = {"Camo"};
		hiddenSelectionsTextures[] = {"\rhsgref\addons\rhsgref_infantry\data_gue\m93_gray_co.paa"};
	};
