call compile preProcessFileLineNumbers "\dzn_EJAM\Functions.sqf";
call compile preProcessFileLineNumbers "\dzn_EJAM\UIFunctions.sqf";
call compile preProcessFileLineNumbers "\dzn_EJAM\Settings.sqf";
...
// Actions; In format [@ID, @DisplayName, @ProgressBarTitle]
dzn_EJAM_FixActions = [
